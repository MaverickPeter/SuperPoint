...
if __name__ == '__main__':
    ...
    import cv2
    extractor = DsiftExtractor(16,16,1)
    image = cv2.imread('/mnt/workspace/workgroup/xxc/oss/code/SuperPointPretrainedNetwork/assets/icl_snippet/250.png')
    print(image.shape)
    ...
    # cv2.imwrite("/mnt/workspace/workgroup/xxc/oss/code/SuperPointPretrainedNetwork/dsift.png", feaArr)
